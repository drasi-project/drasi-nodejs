#!/bin/bash
# Post-create script for the Drasi Node.js Building Comfort tutorial.

set -e

echo "🔧 Initializing Drasi Node.js Building Comfort tutorial environment..."
...
echo "   Next: run 'npm run demo' (you are already in tutorials/building-comfort),"
