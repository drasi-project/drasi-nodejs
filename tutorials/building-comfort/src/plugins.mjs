...
// (ghcr.io/drasi-project) on first run and caches them in a local directory —
// they are never baked in. Mirrors drasi-server's `autoInstallPlugins`.
// Ported from examples/trading/src/main/plugins.ts.
